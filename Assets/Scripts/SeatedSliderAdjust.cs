...
public class SeatedSliderAdjust : MonoBehaviour
{
    ...
    /*void DropdownStudyValueChanged(Dropdown change)
    {
        studyNum *= -1;
    }
    void DropdownGenderValueChanged(Dropdown change)
    {
        gendNum *= -1;
    }*/
    ...
    void Start()
    {
        /*study.onValueChanged.AddListener(delegate {
            DropdownStudyValueChanged(study);
        });
        gender.onValueChanged.AddListener(delegate {
            DropdownGenderValueChanged(gender);
        });*/
