...
public class SliderAdjust : MonoBehaviour
{
    ...
    public void vertsAppear()
    {
        GameObject sphere;
        Vector3[] vertices = mesh.vertices;
        for (int i = predAnthNum; i < predAnthNum + predLandmarkNum; i++)
        {
            sphere = new GameObject("unit");
            ...
            Vector3 temp2 = new Vector3(15, 15, 15);
            sphere.transform.localScale += temp2;
        }
    }
